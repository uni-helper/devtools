!(function (e, n) { typeof exports == 'object' && typeof module != 'undefined' ? module.exports = n() : typeof define == 'function' && define.amd ? define(n) : (e = e || self).uni = n() }(this, () => {
  'use strict'; try { const e = {}; Object.defineProperty(e, 'passive', { get() { !0 } }), window.addEventListener('test-passive', null, e) }
  catch (e) {} const n = Object.prototype.hasOwnProperty; function i(e, i) { return n.call(e, i) } const t = []; function o() { return window.__dcloud_weex_postMessage || window.__dcloud_weex_ } function a() { return window.__uniapp_x_postMessage || window.__uniapp_x_ } const r = function (e, n) {
    const i = { options: { timestamp: +new Date() }, name: e, arg: n }; if (a()) { if (e === 'postMessage') { const r = { data: n }; return window.__uniapp_x_postMessage ? window.__uniapp_x_postMessage(r) : window.__uniapp_x_.postMessage(JSON.stringify(r)) } const d = { type: 'WEB_INVOKE_APPSERVICE', args: { data: i, webviewIds: t } }; window.__uniapp_x_postMessage ? window.__uniapp_x_postMessageToService(d) : window.__uniapp_x_.postMessageToService(JSON.stringify(d)) }
    else if (o()) { if (e === 'postMessage') { const s = { data: [n] }; return window.__dcloud_weex_postMessage ? window.__dcloud_weex_postMessage(s) : window.__dcloud_weex_.postMessage(JSON.stringify(s)) } const w = { type: 'WEB_INVOKE_APPSERVICE', args: { data: i, webviewIds: t } }; window.__dcloud_weex_postMessage ? window.__dcloud_weex_postMessageToService(w) : window.__dcloud_weex_.postMessageToService(JSON.stringify(w)) }
    else {
      if (!window.plus)
      ...
      if (s || w)
        return window.__uniapp_x_postMessage || window.__uniapp_x_ || window.__dcloud_weex_postMessage || window.__dcloud_weex_ ? document.addEventListener('DOMContentLoaded', e) : window.plus && u.test(document.readyState) ? setTimeout(e, 0) : document.addEventListener('plusready', e), d
    }, function (e) {
      if (_)
    ...
    }, function (e) { if (g) { document.addEventListener('DOMContentLoaded', e); const n = window.my; return { navigateTo: n.navigateTo, navigateBack: n.navigateBack, switchTab: n.switchTab, reLaunch: n.reLaunch, redirectTo: n.redirectTo, postMessage: n.postMessage, getEnv: n.getEnv } } }, function (e) {
      if (v)
    ...
    }, function (e) { if (m) { window.QaJSBridge && window.QaJSBridge.invoke ? setTimeout(e, 0) : document.addEventListener('QaJSBridgeReady', e); const n = window.qa; return { navigateTo: n.navigateTo, navigateBack: n.navigateBack, switchTab: n.switchTab, reLaunch: n.reLaunch, redirectTo: n.redirectTo, postMessage: n.postMessage, getEnv: n.getEnv } } }, function (e) {
      if (f)
        return window.WeixinJSBridge && window.WeixinJSBridge.invoke ? setTimeout(e, 0) : document.addEventListener('WeixinJSBridgeReady', e), window.ks.miniProgram
    }, function (e) {
      if (l)
        return document.addEventListener('DOMContentLoaded', e), window.tt.miniProgram
    }, function (e) {
      if (E)
        return window.JDJSBridgeReady && window.JDJSBridgeReady.invoke ? setTimeout(e, 0) : document.addEventListener('JDJSBridgeReady', e), window.jd.miniProgram
    }, function (e) {
      if (x)
